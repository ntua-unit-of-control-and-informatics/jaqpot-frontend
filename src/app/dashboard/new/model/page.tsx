...
export default function Page() {
  return (
    <div className="flex flex-col gap-5 items-start p-4">
      ...
      <p>
        Follow these instructions to set up and use the <Code>jaqpotpy</Code>{' '}
        library to create and upload a new model.
      </p>
      ...
      <pre className="bg-gray-100 p-5 rounded-md text-sm leading-tight">
        {`
