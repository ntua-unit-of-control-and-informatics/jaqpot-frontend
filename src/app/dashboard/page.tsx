      ...
      <div className="relative isolate min-h-screen px-6 py-5 sm:py-0 lg:px-8">
        ...
        >
          <div
            ...
            className="relative left-[calc(50%+3rem)] top-20 aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30 sm:-top-40 sm:left-[calc(20%+36rem)] sm:w-[36.1875rem]"
          />
        </div>
      </div>
