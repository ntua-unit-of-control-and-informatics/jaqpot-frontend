    ...
    <>
      ...
      >
        <div className="flex flex-col gap-y-5">
          <div className="h-16 px-5 py-4 flex text-white">
            <BeakerIcon className="size-6 text-indigo-200" />
            <Logo />
          </div>
          <nav className="h-full px-3 py-4 overflow-y-auto">
            <ul className="space-y-2 font-medium">
              <li>
                ...
                >
                  <svg
                    className="w-5 h-5 text-indigo-200 transition duration-75 dark:text-gray-400 group-hover:text-white dark:group-hover:text-white"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    viewBox="0 0 22 21"
